...
I am a software engineer focused on turning complex requirements into secure, observable, and maintainable products. I work across system design, backend platforms, modern web applications, cloud infrastructure, and developer experience. My engineering decisions balance customer value, delivery speed, operational simplicity, and long-term reliability.

My AI and machine learning work covers data pipelines, model development, retrieval-augmented generation, evaluation, deployment, and production monitoring. I build full-stack experiences that make intelligent systems useful, measurable, and safe for real users. I approach every initiative with a product engineering mindset: define the problem clearly, validate assumptions early, ship in small increments, and measure outcomes.
